...
class cacti_result_type
{
	public:
		cacti_result_type()
		: access_time(0), cycle_time(0), best_Ndwl(0), best_Ndbl(0), best_Nspd(0), best_Ntwl(0),
			best_Ntbl(0), best_Ntspd(0), 
			decoder_delay_data(0),decoder_delay_tag(0),
			dec_data_driver(0), dec_data_3to8(0), dec_data_inv(0),
			dec_tag_driver(0), dec_tag_3to8(0), dec_tag_inv(0),
			wordline_delay_data(0), wordline_delay_tag(0),
			bitline_delay_data(0), bitline_delay_tag(0),
			sense_amp_delay_data(0), sense_amp_delay_tag(0),
			compare_part_delay(0), drive_mux_delay(0), selb_delay(0),
			data_output_delay(0), drive_valid_delay(0), precharge_delay(0)
		{}
