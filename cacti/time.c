...
cacti_result_type cacti_calculate_time(cacti_parameter_type *parameters)
{
	cacti_result_type retval;
	...
	//Because of area considerations, I don't think it makes sense to break either dimension up larger than MAXN

	retval.cycle_time = BIGNUM;
	retval.access_time = BIGNUM;
   for (Nspd=1;Nspd<=MAXSPD;Nspd=Nspd*2) {
	...
	if (organizational_parameters_valid
		...
		*/
	    ...
	    if (retval.cycle_time+1e-11*(retval.best_Ndwl+retval.best_Ndbl+retval.best_Nspd+retval.best_Ntwl+retval.best_Ntbl+retval.best_Ntspd) > cycle_time/FUDGEFACTOR+1e-11*(Ndwl+Ndbl+Nspd+Ntwl+Ntbl+Ntspd)) {
	       retval.cycle_time = cycle_time/FUDGEFACTOR;
	       retval.access_time = access_time/FUDGEFACTOR;
	       retval.best_Ndwl = Ndwl;
	       retval.best_Ndbl = Ndbl;
	       retval.best_Nspd = Nspd;
	       retval.best_Ntwl = Ntwl;
	       retval.best_Ntbl = Ntbl;
	       retval.best_Ntspd = Ntspd;
	       retval.decoder_delay_data = decoder_data/FUDGEFACTOR;
	       retval.decoder_delay_tag = decoder_tag/FUDGEFACTOR;
	       retval.dec_tag_driver = decoder_tag_driver/FUDGEFACTOR;
	       retval.dec_tag_3to8 = decoder_tag_3to8/FUDGEFACTOR;
	       retval.dec_tag_inv = decoder_tag_inv/FUDGEFACTOR;
	       retval.dec_data_driver = decoder_data_driver/FUDGEFACTOR;
	       retval.dec_data_3to8 = decoder_data_3to8/FUDGEFACTOR;
	       retval.dec_data_inv = decoder_data_inv/FUDGEFACTOR;
	       retval.wordline_delay_data = wordline_data/FUDGEFACTOR;
	       retval.wordline_delay_tag = wordline_tag/FUDGEFACTOR;
	       retval.bitline_delay_data = bitline_data/FUDGEFACTOR;
	       retval.bitline_delay_tag = bitline_tag/FUDGEFACTOR;
	       retval.sense_amp_delay_data = sense_amp_data/FUDGEFACTOR;
	       retval.sense_amp_delay_tag = sense_amp_tag/FUDGEFACTOR;
	       retval.compare_part_delay = compare_tag/FUDGEFACTOR;
	       retval.drive_mux_delay = mux_driver/FUDGEFACTOR;
	       retval.selb_delay = selb/FUDGEFACTOR;
	       retval.drive_valid_delay = valid_driver/FUDGEFACTOR;
	       retval.data_output_delay = data_output/FUDGEFACTOR;
	       retval.precharge_delay = precharge_del/FUDGEFACTOR;
	    }
	  }
	 }
	}
