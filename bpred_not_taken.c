...
bpred_bpred_not_taken::bpred_bpred_not_taken()
: bpred_t("nottaken")
{}

md_addr_t bpred_bpred_not_taken::bpred_lookup(md_addr_t baddr,		//branch address
...
void bpred_bpred_not_taken::bpred_update(md_addr_t,
	md_addr_t,
...
void bpred_bpred_not_taken::bpred_config(FILE *stream)
{
